package com.quizapp.tollywood.configuration;
...
import com.quizapp.tollywood.databaseutils.UserPreferences;
...
public class Config{
	...
	public static final String playStoreUrl = "https://play.google.com/store/apps/details?badgeId=com.quizapp.tollywood";
	public static final String sharingAppText = "Try this app \n "+playStoreUrl;
	public static final int NOTIFICATION_ID_SERVER_PUSH = 10;
	public static final String GCM_NOTIFICATION_INTENT_ACTION = "com.quizapp.tollywood.gcmnotification";
