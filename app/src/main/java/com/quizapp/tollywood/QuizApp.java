...
import com.quizapp.tollywood.Screen.ScreenType;
...
import com.quizapp.tollywood.databaseutils.DatabaseHelper;
...
import com.quizapp.tollywood.notificationutils.NotifificationProcessingState;
import com.quizapp.tollywood.popups.StaticPopupDialogBoxes;
		...
		synchronized (uiSync) {
			...
			switch (id) {
				...
				case MENU_SHARE_WITH_FRIENDS:
					...
					sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Play realtime quizzes with your friends on com.quizapp.tollywood.");
					String link = "https://play.google.com/store/apps/details?id=com.quizapp.tollywood";
